...
#ifndef __ST_PPL_KERNEL_X86_COMMON_NEG_NEG_COMMON_H_
#define __ST_PPL_KERNEL_X86_COMMON_NEG_NEG_COMMON_H_
...
#endif // __ST_PPL_KERNEL_X86_COMMON_NEG_NEG_COMMON_H_
