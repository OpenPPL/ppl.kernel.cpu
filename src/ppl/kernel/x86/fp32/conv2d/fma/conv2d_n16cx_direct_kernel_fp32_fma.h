...
class conv2d_n16cx_direct_kernel_fp32_fma {
public:
    ...
    struct param_def {
        ...
        static const int64_t SRC_DH_STRIDE_IDX = 8;
        static const int64_t SRC_DW_STRIDE_IDX = 9;
        static const int64_t SRC_SW_STRIDE_IDX = 10;
        static const int64_t KH_START_IDX = 11;
        static const int64_t KH_END_IDX = 12;
        static const int64_t KW_START_IDX = 13;
        static const int64_t KW_END_IDX = 14;
        static const int64_t KH_IDX = 15;
        static const int64_t KW_IDX = 16;
        static const int64_t FLAGS_IDX = 17;
        static const int64_t LENGTH = 18;
    };

    struct config {
        static const int64_t IC_DATA_BLK = 16;
        static const int64_t OC_DATA_BLK = 16;
        static const int64_t MAX_W_REGS = 6;
        ...
        static const int64_t STRIDE_W_OPT = 3;
    };
    ...
    conv2d_n16cx_direct_kernel_fp32_fma(int64_t *param) : param_(param) { }
    inline void set_param(int64_t *param) { this->param_ = param; }
    inline int64_t *param() { return param_; }

    inline void execute(const int64_t nt_store, const int64_t spec_stride_w, const int64_t oc_reg, const int64_t w_reg) {
        table_[nt_store][spec_stride_w][oc_reg - 1][w_reg - 1](param_);
    }
...
private:
    int64_t *param_;
    static const func_t table_[config::NT_STORE_OPT][config::STRIDE_W_OPT][config::MAX_OC_REGS][config::MAX_W_REGS];
