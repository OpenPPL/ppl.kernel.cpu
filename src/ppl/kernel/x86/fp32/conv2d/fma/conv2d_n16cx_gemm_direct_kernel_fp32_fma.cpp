...
void conv2d_n16cx_gemm_direct_fp32_fma_blk1x6_kernel_core(int64_t *param)
{
    __asm__ __volatile__ (
        ...
        ".equ U_OCR, ((U_OC + OC_REG_ELTS - 1) / OC_REG_ELTS)\n"
...
"51:\n" // label_ic_body_inner
        ...
        ".endif\n"
        ".if U_S > 0\n"
        "vbroadcastss ((\\IC - 4 + 0 * IC_DATA_BLK) * D_BYTES)(%%rax), %%ymm12\n"
        ".if U_OCR > 0\n vfmadd231ps %%ymm14, %%ymm12, %%ymm0\n .endif\n"
        ".if U_OCR > 1\n vfmadd231ps %%ymm15, %%ymm12, %%ymm1\n .endif\n"
        ".endif\n"
        ".if U_S > 1\n"
        "vbroadcastss ((\\IC - 4 + 1 * IC_DATA_BLK) * D_BYTES)(%%rax), %%ymm13\n"
        ".if U_OCR > 0\n vfmadd231ps %%ymm14, %%ymm13, %%ymm2\n .endif\n"
        ".if U_OCR > 1\n vfmadd231ps %%ymm15, %%ymm13, %%ymm3\n .endif\n"
        ".endif\n"
        ".if U_S > 2\n"
        "vbroadcastss ((\\IC - 4 + 2 * IC_DATA_BLK) * D_BYTES)(%%rax), %%ymm12\n"
        ".if U_OCR > 0\n vfmadd231ps %%ymm14, %%ymm12, %%ymm4\n .endif\n"
        ".if U_OCR > 1\n vfmadd231ps %%ymm15, %%ymm12, %%ymm5\n .endif\n"
        ".endif\n"
        ".if U_S > 3\n"
        "vbroadcastss ((\\IC - 4 + 3 * IC_DATA_BLK) * D_BYTES)(%%rax), %%ymm13\n"
        ".if U_OCR > 0\n vfmadd231ps %%ymm14, %%ymm13, %%ymm6\n .endif\n"
        ".if U_OCR > 1\n vfmadd231ps %%ymm15, %%ymm13, %%ymm7\n .endif\n"
        ".endif\n"
        ".if U_S > 4\n"
        "vbroadcastss ((\\IC - 4 + 4 * IC_DATA_BLK) * D_BYTES)(%%rax), %%ymm12\n"
        ".if U_OCR > 0\n vfmadd231ps %%ymm14, %%ymm12, %%ymm8\n .endif\n"
        ".if U_OCR > 1\n vfmadd231ps %%ymm15, %%ymm12, %%ymm9\n .endif\n"
        ".endif\n"
        ".if U_S > 5\n"
        "vbroadcastss ((\\IC - 4 + 5 * IC_DATA_BLK) * D_BYTES)(%%rax), %%ymm13\n"
        ".if U_OCR > 0\n vfmadd231ps %%ymm14, %%ymm13, %%ymm10\n .endif\n"
        ".if U_OCR > 1\n vfmadd231ps %%ymm15, %%ymm13, %%ymm11\n .endif\n"
        ".endif\n"
        ".endr\n"
...
"6:\n" // label_ic_remain
        ...
        ".if U_S > 0\n"
        "vbroadcastss ((-1 + 0 * IC_DATA_BLK) * D_BYTES)(%%rax), %%ymm12\n"
        ".if U_OCR > 0\n vfmadd231ps %%ymm14, %%ymm12, %%ymm0\n .endif\n"
        ".if U_OCR > 1\n vfmadd231ps %%ymm15, %%ymm12, %%ymm1\n .endif\n"
        ".endif\n"
        "sub $1, %%r10\n"
        ".if U_S > 1\n"
        "vbroadcastss ((-1 + 1 * IC_DATA_BLK) * D_BYTES)(%%rax), %%ymm13\n"
        ".if U_OCR > 0\n vfmadd231ps %%ymm14, %%ymm13, %%ymm2\n .endif\n"
        ".if U_OCR > 1\n vfmadd231ps %%ymm15, %%ymm13, %%ymm3\n .endif\n"
        ".endif\n"
        ".if U_S > 2\n"
        "vbroadcastss ((-1 + 2 * IC_DATA_BLK) * D_BYTES)(%%rax), %%ymm12\n"
        ".if U_OCR > 0\n vfmadd231ps %%ymm14, %%ymm12, %%ymm4\n .endif\n"
        ".if U_OCR > 1\n vfmadd231ps %%ymm15, %%ymm12, %%ymm5\n .endif\n"
        ".endif\n"
        ".if U_S > 3\n"
        "vbroadcastss ((-1 + 3 * IC_DATA_BLK) * D_BYTES)(%%rax), %%ymm13\n"
        ".if U_OCR > 0\n vfmadd231ps %%ymm14, %%ymm13, %%ymm6\n .endif\n"
        ".if U_OCR > 1\n vfmadd231ps %%ymm15, %%ymm13, %%ymm7\n .endif\n"
        ".endif\n"
        ".if U_S > 4\n"
        "vbroadcastss ((-1 + 4 * IC_DATA_BLK) * D_BYTES)(%%rax), %%ymm12\n"
        ".if U_OCR > 0\n vfmadd231ps %%ymm14, %%ymm12, %%ymm8\n .endif\n"
        ".if U_OCR > 1\n vfmadd231ps %%ymm15, %%ymm12, %%ymm9\n .endif\n"
        ".endif\n"
        ".if U_S > 5\n"
        "vbroadcastss ((-1 + 5 * IC_DATA_BLK) * D_BYTES)(%%rax), %%ymm13\n"
        ".if U_OCR > 0\n vfmadd231ps %%ymm14, %%ymm13, %%ymm10\n .endif\n"
        ".if U_OCR > 1\n vfmadd231ps %%ymm15, %%ymm13, %%ymm11\n .endif\n"
        ".endif\n"
        "jne 6b\n" // label_ic_remain
...
{
#ifdef PPL_USE_X86_INLINE_ASM
    conv2d_n16cx_gemm_direct_fp32_fma_blk1x6_kernel_core<nt_store, u_oc, u_s>(param);
    return;
#endif
