...
#include "ppl/kernel/x86/fp32/conv2d/sse/conv2d_n8cx_direct_kernel_fp32_sse.h"
...
int64_t conv2d_n8cx_direct_fp32_sse_executor::cal_ic_l2_blk(const conv2d_param &param)
{
...
ppl::common::RetCode conv2d_n8cx_direct_fp32_sse_manager::gen_cvt_weights(const float *filter, const float *bias)
{
    ...
    const int64_t ic_l2_blk = conv2d_n8cx_direct_fp32_sse_executor::cal_ic_l2_blk(param_);
