...
static inline void arithmetic_broadcast_lastdim_no_broadcast_ndarray_scalar_int64(
    const int64_t* src0,
    const int64_t* src1,
    int64_t* dst,
    const int64_t start,
...
template <arithmetic_op_type_t op, bool fuse_relu>
static inline void arithmetic_broadcast_lastdim_src0_broadcast_ndarray_scalar_int64(
    const int64_t* src0,
    const int64_t* src1,
    int64_t* dst,
    const int64_t start,
...
template <arithmetic_op_type_t op, bool fuse_relu>
static inline void arithmetic_broadcast_lastdim_src1_broadcast_ndarray_scalar_int64(
    const int64_t* src0,
    const int64_t* src1,
    int64_t* dst,
    const int64_t start,
...
template <arithmetic_op_type_t op, bool fuse_relu>
static ppl::common::RetCode arithmetic_broadcast_recursive_ndarray_scalar_int64(
    const int64_t* src0,
    const int64_t* src1,
    int64_t* dst,
    ...
    parallel_block* block)
{
    ...
    if (dim_idx == dim_count - 1) {
        if (src0_shape[dim_idx] == src1_shape[dim_idx]) {
            arithmetic_broadcast_lastdim_no_broadcast_ndarray_scalar_int64<op, fuse_relu>(src0, src1, dst, start, end);
        } else if (src0_shape[dim_idx] == 1) {
            arithmetic_broadcast_lastdim_src0_broadcast_ndarray_scalar_int64<op, fuse_relu>(src0, src1, dst, start, end);
        } else if (src1_shape[dim_idx] == 1) {
            arithmetic_broadcast_lastdim_src1_broadcast_ndarray_scalar_int64<op, fuse_relu>(src0, src1, dst, start, end);
        }
    } else {
                                                                      ...
                                                                      const ppl::common::TensorShape* dst_shape)
{
    ...
    arithmetic_broadcast_recursive_ndarray_scalar_int64<op, fuse_relu>(src0, src1, dst, real_src0_shape, real_src1_shape, real_dst_shape, inc0, inc1, inc_out, real_dim_count, 0, &block);
                                                               ...
                                                               const ppl::common::TensorShape* dst_shape)
{
    ...
    arithmetic_broadcast_recursive_ndarray_int64<op, fuse_relu>(src0, src1, dst, real_src0_shape, real_src1_shape, real_dst_shape, inc0, inc1, inc_out, real_dim_count, 0, &block);
